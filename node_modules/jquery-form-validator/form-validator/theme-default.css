...
input.valid {
        /* border-color: #468847; */
        /* background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAMAAAAoLQ9TAAAABGdBT…Aw6tSWKgAAABl0RVh0U29mdHdhcmUAd3d3Lmlua3NjYXBlLm9yZ5vuPBoAAAAASUVORK5CYII=); */
        background-position: right 5px center;
        background-repeat: no-repeat;
        /* -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,0.075); */
        /* box-shadow: inset 0 1px 1px rgba(0,0,0,0.075); */
        border-bottom-color: #71b88a !important;
}
